...
public class EscapeRaceTexts {
	...
	public static final Component VACATION_DAY = Component.literal("\u0355").withStyle(Style.EMPTY.withColor(CommonColors.WHITE).withFont(new FontDescription.Resource(Identifier.fromNamespaceAndPath("lt", "ui"))));

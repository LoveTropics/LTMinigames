...
public class ActionTargetTypes {
	...
	public static final DeferredHolder<Codec<? extends ActionTarget<?>>, Codec<LivingEntityActionTarget>> LIVING_ENTITY = register("living_entity", LivingEntityActionTarget.CODEC);

...
import org.lovetropics.games.common.core.game.lobby.GameLobbyId;
import org.lovetropics.games.common.dev.DevQuickPlay;
...
public final class PlayerRoleSelections {
	...
	private void sendPromptTo(ServerPlayer player) {
		...
		Util.sendNotifySound(player, SoundEvents.ARROW_HIT_PLAYER, SoundSource.MASTER, 1.0F, 1.0F);
	}
